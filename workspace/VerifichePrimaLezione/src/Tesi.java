...
public class Tesi {
	...
	public static void main(String[] args) {
		...
		System.out.println(tesi.getRelatore().getCognome() + " " + tesi.getRelatore().getNome() + " "
				+ tesi.getRelatore().getEta());

		System.out.println("Studente:");
		System.out.println(tesi.getStudente().getCognome() + " " + tesi.getStudente().getNome() + " "
				+ tesi.getStudente().getEta());
