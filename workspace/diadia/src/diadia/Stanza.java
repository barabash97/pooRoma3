...
public class Stanza {
	...
	static final private int NUMERO_MASSIMO_ATTREZZI = 2;
	...
	public String toString() {
		...
		for (Attrezzo attrezzo : this.attrezzi) {
			try {
				...
				System.out.println(this.getLengthAttrezzi(this.attrezzi));
			}
		}
		System.out.println("Numero attrezzi: " + this.getLengthAttrezzi(this.attrezzi));
	...
	public static void die() {
		System.out.println("Arriva a questo punto");
		System.exit(1);
	}
	
	public static int getLengthAttrezzi(Attrezzo[] arr){
	    int count = 0;
	    for(Attrezzo el : arr)
	        if (el != null)
	            ++count;
